...
Establish the "best" SN embedding result using 3 top models (opus, gemini-3-flash-preview, gpt-5.4) as a consensus panel. The prompt evolves live during the run, not after.
