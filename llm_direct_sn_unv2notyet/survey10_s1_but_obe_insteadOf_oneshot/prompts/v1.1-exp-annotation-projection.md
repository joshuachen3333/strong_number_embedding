# Experiment: Annotation Projection Framing
# Base: v1.1_Gen_1_1.md
# Purpose: Test whether academic task framing improves model output
# NOT a version bump — parallel experiment against v1.1 gold standard
# Date: 2026-03-20
#
# --- Hypothesis ---
# Naming the task as "Annotation Projection" and providing actionable
# implications may activate relevant NLP knowledge in the models,
# leading to better SN placement (higher R1 unanimous rate, faster
# convergence, fewer errors).
