...
| 類別 | 代表經節 | 測什麼 |
|------|---------|--------|
| 簡單短節 | Gen 1:5, 1:19 | 基本 SN 放置 |
| Implicit markers 多 | Gen 1:1, 1:4 | {<WH0853>} 處理 |
| 900x prefixes | Gen 1:5, 1:6 | <WAH09002> 保留 |
| Morphology codes | Gen 1:1, 1:3 | <WTH8804> 放置 |
| 複合介系詞 | Gen 1:7 | <WAH04480><WH05921> |
| 長節多 SN | Gen 1:21, 1:28 | 大量 tag 不漏不亂 |
| 重複平行結構 | Gen 1:11, 1:12 | 各從其類 ×2 |
