...
去殼前 UNV+SN 建表:
  ...
  0430  → <WH0430>
  8804  → <WTH8804>
  0853  → {<WH0853>}  (implicit)

LLM 輸出:  太初<09002><07225>，上帝<0430>創造<01254><8804><0853>天<08064><0853>地<0776>。
查表加殼:  太初<WAH09002><WH07225>，上帝<WH0430>創造<WH01254><WTH8804>{<WH0853>}天<WH08064>{<WH0853>}地<WH0776>。
```

不需要 restore_shell_guess（猜）。直接查表（100% 正確）。
